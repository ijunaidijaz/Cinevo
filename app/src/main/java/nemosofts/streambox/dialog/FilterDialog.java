...
public class FilterDialog {
    ...
    public FilterDialog(Context context, int pageType, FilterDialogListener filterListener) {
        ...
        if (Boolean.TRUE.equals(flag)){
            ...
            newest.setTextColor(ContextCompat.getColor(context, R.color.ns_classic_title_sub));
            if (ApplicationUtil.isTvBox(context)){
                oldest.requestFocus();
            }
        } else {
            oldest.setTextColor(ContextCompat.getColor(context, R.color.ns_classic_title_sub));
