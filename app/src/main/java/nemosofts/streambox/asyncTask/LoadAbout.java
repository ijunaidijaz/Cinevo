            ...
            try {
                ...
                if (jsonObject.has("details")) {
                    ...
                    for (int i = 0; i < jsonArrayDetails.length(); i++) {
                        ...
                        Boolean is_local_storage=false;
                        try {
                            if(c.getString("is_local_storage")!=null ) {
                                is_local_storage = Boolean.parseBoolean(c.getString("is_local_storage"));
                            }
                        }catch (Exception e){
                            Log.d("is_local_storage", "doInBackground: "+e.getLocalizedMessage());
                        }
