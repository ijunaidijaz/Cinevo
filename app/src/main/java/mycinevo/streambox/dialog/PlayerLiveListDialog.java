...
import mycinevo.streambox.adapter.player.AdapterLivePlayer;
import mycinevo.streambox.callback.Callback;
import mycinevo.streambox.util.IfSupported;

public class PlayerLiveListDialog {

    private Dialog dialog;
    private final Activity ctx;
    private final PlayerLiveListListener listener;

    public PlayerLiveListDialog(Activity ctx, PlayerLiveListListener listener) {
        this.ctx = ctx;
    ...
    public void showDialog() {
        ...
        AdapterLivePlayer adapter = new AdapterLivePlayer(ctx, Callback.arrayListLive, (item, position) -> {
            try {
