...
import mycinevo.streambox.asyncTask.GetMoviesPlaylist;
...
public class PlaylistMovieActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        helper = new Helper(this, (position, type) -> {
            @SuppressLint("UnsafeOptInUsageError") Intent intent = new Intent(PlaylistMovieActivity.this, PlayerSingleURLActivity.class);
