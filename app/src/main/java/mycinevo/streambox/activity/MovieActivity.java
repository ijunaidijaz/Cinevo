...
import mycinevo.streambox.asyncTask.GetMovies;
...
public class MovieActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        helper = new Helper(this, (position, type) -> {
            @SuppressLint("UnsafeOptInUsageError") Intent intent = new Intent(this, DetailsMovieActivity.class);
        ...
        findViewById(R.id.iv_filter).setOnClickListener(v -> new FilterDialog(this, 2, () -> recreate_data(pos)));
    ...
    private void getData() {
        loadMovies = new GetMovies(this, page, cat_id, is_page, new GetMovieListener() {
            @Override
            public void onStart() {
