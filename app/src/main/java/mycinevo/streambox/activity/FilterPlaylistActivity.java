...
import mycinevo.streambox.asyncTask.GetLivePlaylist;
...
public class FilterPlaylistActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new NSoftsProgressDialog(FilterPlaylistActivity.this);
    ...
    private void recreate_data(int position) {
        if (!arrayListCat.isEmpty() && position < arrayListCat.size()) {
            pos = position;
            ...
            Toasty.makeText(FilterPlaylistActivity.this, getString(R.string.err_no_data_found), Toasty.ERROR);
        }
    }
