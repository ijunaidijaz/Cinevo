...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final YoutubeplayerLibraryAccessors laccForYoutubeplayerLibraryAccessors = new YoutubeplayerLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>library</b> with <b>com.github.nemosofts:library</b> coordinates and
    ...
    /**
     * Dependency provider for <b>oneSignal</b> with <b>com.onesignal:OneSignal</b> coordinates and
     * with version reference <b>onesignal</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Dependency provider for <b>scytale</b> with <b>com.yakivmospan:scytale</b> coordinates and
     * with version reference <b>scytale</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Group of libraries at <b>youtubeplayer</b>
     */
    public YoutubeplayerLibraryAccessors getYoutubeplayer() {
        return laccForYoutubeplayerLibraryAccessors;
    }
    ...
    public static class ExoplayerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>rtsp</b> with <b>androidx.media3:media3-exoplayer-rtsp</b> coordinates and
         * with version reference <b>media3Exoplayer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>firebase.inappmessaging</b>
         */
    ...
    public static class FirebaseInappmessagingLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>display</b> with <b>com.google.firebase:firebase-inappmessaging-display</b> coordinates and
         * with version reference <b>firebaseInappmessagingDisplay</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class Media3LibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>container</b> with <b>androidx.media3:media3-container</b> coordinates and
         * with version reference <b>media3Exoplayer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Dependency provider for <b>decoder</b> with <b>androidx.media3:media3-decoder</b> coordinates and
         * with version reference <b>media3Exoplayer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDecoder() {
            return create("media3.decoder");
        }
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getInterceptor() {
            return create("okhttp.interceptor");
        }

    }

    public static class YoutubeplayerLibraryAccessors extends SubDependencyFactory {

        public YoutubeplayerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>com.pierfrancescosoffritti.androidyoutubeplayer:core</b> coordinates and
         * with version reference <b>youtubePlayer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("youtubeplayer.core");
        }

        /**
         * Dependency provider for <b>ui</b> with <b>com.pierfrancescosoffritti.androidyoutubeplayer:custom-ui</b> coordinates and
         * with version reference <b>youtubePlayer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getUi() {
            return create("youtubeplayer.ui");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>commonsIo</b> with value <b>2.13.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseInappmessagingDisplay</b> with value <b>21.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>library</b> with value <b>2.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>onesignal</b> with value <b>5.1.15</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>scytale</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>youtubePlayer</b> with value <b>12.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getYoutubePlayer() { return getVersion("youtubePlayer"); }

    }

    public static class BundleAccessors extends BundleFactory {
        private final NetworkBundleAccessors baccForNetworkBundleAccessors = new NetworkBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);

        public BundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>exoplayer</b> which contains the following dependencies:
         * <ul>
         ...
         *    <li>androidx.media3:media3-datasource</li>
         *    <li>androidx.media3:media3-decoder</li>
        ...
        /**
         * Dependency bundle provider for <b>nemosofts</b> which contains the following dependencies:
         * <ul>
        ...
        /**
         * Dependency bundle provider for <b>youtubeplayer</b> which contains the following dependencies:
         * <ul>
         *    <li>com.pierfrancescosoffritti.androidyoutubeplayer:core</li>
         *    <li>com.pierfrancescosoffritti.androidyoutubeplayer:custom-ui</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         */
        public Provider<ExternalModuleDependencyBundle> getYoutubeplayer() {
            return createBundle("youtubeplayer");
        }

        /**
         * Group of bundles at <b>bundles.network</b>
         */
        public NetworkBundleAccessors getNetwork() {
            return baccForNetworkBundleAccessors;
        }
    ...
    public static class NetworkBundleAccessors extends BundleFactory {
        ...
        public NetworkBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>network.security</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getSecurity() {
            return createBundle("network.security");
        }
